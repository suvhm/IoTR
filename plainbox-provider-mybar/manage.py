...
setup(
    name='2018.com.canonical.qa.mybar:plainbox-provider-mybar',
    version="1.0",
    description=N_("The 2018.com.canonical.qa.mybar:plainbox-provider-mybar provider"),
    gettext_domain="2018_com_canonical_qa_mybar_plainbox-provider-mybar",
)